...
\subsection{Plots and Diagrams}
\label{subsec:PlotsAndDiagrams}
...
\begin{figure}[!tb]
	...
	\begin{subfigure}{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth, alt={A plot of sine and cosine}]{Figures/example_figure_matplotlib_096.png}
