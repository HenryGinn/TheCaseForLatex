...
This document serves to highlight functionality of \LaTeX\, therefore code snippets are given for demonstration purposes only. Below I have included the code used to create this section as an example of what \LaTeX\ may look for typical users\footnote{Note that this is done by reference to a file so it will update whenever this introduction is changed. This ``single source of truth" philosophy is common in \LaTeX.}. Pressing the compile button converts this into a PDF.