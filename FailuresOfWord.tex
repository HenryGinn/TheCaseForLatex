...
Several times I have had to attach spreadsheets as an appendix to a pdf as part of a deliverable\footnote{Personally I believe this is not best practice and we should be sending the native file, but we will ignore that.}. Below is the process we use to get the page numbers at the bottom of the page correct and the links and page numbers in the table of contents to be correct:

\begin{enumerate}
	\item Go to the first sheet of the spreadsheet being included, change the ``start at page number" setting to match the position it belongs in the document.
...
\subsection{Assorted Complaints}
